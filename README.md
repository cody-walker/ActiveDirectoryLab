...
**Screenshot: `Screenshot_2.3.png`**

![Windows Server install](screenshots/Screenshot_2.3.png)
...
**Screenshot: `Screenshot_3.1.png`**

![AD DS role install](screenshots/Screenshot_3.1.png)
...
**Screenshot: `Screenshot_4.0.png`**

![Promote to DC wizard](screenshots/Screenshot_4.0.png)
...
**Screenshot: `Screenshot_5.0.png`**

![Domain login proof](screenshots/Screenshot_5.0.png)
...
**Screenshot: `Screenshot_6.0.png`**

![OU structure](screenshots/Screenshot_6.0.png)
Created OUs mirroring a small company's departments: IT, Sales, and HR.

### 7. Creating test user accounts
**Screenshot: `Screenshot_7.0.png`**

![New user wizard](screenshots/Screenshot_7.0.png)
...
**Screenshot: `Screenshot_12.0.png`**

![Disabled account](screenshots/Screenshot_12.0.png)
...
**Screenshot: `Screenshot_13.0.png`**

![Moved user between OUs](screenshots/Screenshot_13.0.png)
...
**Screenshot: `Screenshot_14.0.png`**

![Domain join proof](screenshots/Screenshot_14.0.png)
...
**Screenshot: `Screenshot_15.0.png`**

![Domain user login](screenshots/Screenshot_15.0.png)
...
**Screenshot: `Screenshot_16.0.png`**

![Sales-linked GPO](screenshots/Screenshot_16.0.png)
...
**Screenshots: `Screenshot_20.0.png` (Password Policy) and `Screenshot_21.0.png` (Account Lockout Policy)**

![Default Domain Policy - Password Policy](screenshots/Screenshot_20.0.png)

![Default Domain Policy - Account Lockout Policy](screenshots/Screenshot_21.0.png)
...
**Screenshot: `Screenshot_18.0.png`**

![gpupdate force](screenshots/Screenshot_18.0.png)
...
**Screenshot: `Screenshot_22.0.png`**

![net accounts confirmation](screenshots/Screenshot_22.0.png)
...
**Screenshot: `Screenshot_23.0.png`**

![Lockout triggered](screenshots/Screenshot_23.0.png)
...
**Screenshot: `Screenshot_24.0.png`**

![Lockout confirmed in AD](screenshots/Screenshot_24.0.png)
...
**Screenshot: `Screenshot_25.0.png`**

![Lockout resolved](screenshots/Screenshot_25.0.png)
